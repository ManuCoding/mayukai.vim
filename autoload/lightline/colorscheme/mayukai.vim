...
let s:perlwinkle=[ s:g_perlwinkle, s:t_perlwinkle ]
...
let s:p.visual.left=[ [ s:black, s:perlwinkle ], [ s:white, s:gray ] ]
let s:p.visual.middle=[ [ s:white, s:black ] ]
let s:p.visual.right=[ [ s:black, s:perlwinkle ], [ s:white, s:gray ] ]
